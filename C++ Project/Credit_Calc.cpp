...
/* Function of calculating credit score*/
int applicant:: calc_liability()
{
    int score=0; /*Initialising the score variable for storing credit score*/
    int liability;
    ...
    while(1)
    {
        ...
        switch(ch)
        {
            ...
            case('2'):
            {
                ...
                {
                    gotoxy(22,18);
                    cout<<"Loan applicant's details not yet enterd! Press any key to continue. .";
                    getch();
                }
                else 
                  a.display_score();
